...
export const SINONIMOAK: SynonymEntry[] = [
  ...
  { hitz: "esanahia", sinonimoak: ["esangura", "adiera", "esankizun"], mota: 'izena' },
  ...
  { hitz: "ukitua", sinonimoak: ["dei"], mota: 'izena' },
  ...
  { hitz: "zaratatsua", sinonimoak: ["arramatsu", "astrapalatsu"], mota: 'besteak' },
  { hitz: "oztopoa", sinonimoak: ["destorbu", "eragozpen", "traba"], mota: 'izena' },
  ...
  { hitz: "kartela", sinonimoak: ["afixa", "idazkun"], mota: 'izena' },
  { hitz: "arerioa", sinonimoak: ["etsai", "aurkari", "izterbegi"], mota: 'izena' },
  ...
  { hitz: "atzaparra", sinonimoak: ["erpe", "atzamar"], mota: 'izena' },
